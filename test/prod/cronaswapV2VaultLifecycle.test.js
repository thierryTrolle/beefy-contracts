...
import { cronos } from "../../node_modules/blockchain-addressbook/build/address-book/cronos";
...
const { beefyfinance } = cronos.platforms;

const config = {
  vault: "0x82cd999df2e9034E558221bfbd5fA42276EecE5c", // Set this to the address of your vault after it deploys
  vaultContract: "BeefyVaultV6",
  strategyContract: "StrategyCronaMasterChefV2LP",
  testAmount: ethers.utils.parseEther("20"),
...
describe("cronaSwapV2VaultLifecycle.test.js", () => {
